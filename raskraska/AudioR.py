...
def record_and_recognize_audio(*args: tuple, flag=0):
    """
    ...
    with microphone:
        ...
        try:
            if flag == 0:
                print('Выберите голосом модуль...')
            if flag == 1:
                print("Назовите элемент...")
            if flag == 2:
                print('Какой элемент изменить...')
            if flag == 3:
                print('На какой цвет изменить...')
            ...
            if flag == 0:
                print('Выберите голосом модуль!!!')
            if flag == 1:
                print('Выберите элемент и назовите его!!!')
